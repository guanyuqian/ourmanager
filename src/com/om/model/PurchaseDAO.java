...
/**
 	* A data access object (DAO) providing persistence and search support for Purchase entities.
...
public class PurchaseDAO  {
    ...
    public Purchase findById( java.lang.Integer id) {
        ...
        try {
            Purchase instance = (Purchase) getCurrentSession()
                    .get("com.om.model.Purchase", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Purchase instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("com.om.model.Purchase") .add(Example.create(instance)).list();
    ...
    public Purchase merge(Purchase detachedInstance) {
        ...
        try {
            Purchase result = (Purchase) getCurrentSession()
